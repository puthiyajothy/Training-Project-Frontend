...
getLow(){
    ...
    getStatusFixed(){
        axios
        .get('http://localhost:8085/defectservices/getStatusFixed')
        .then(res=> {
            this.setState({
    ...
    getStatusDefered(){
        axios
        .get('http://localhost:8085/defectservices/getStatusDefered')
        .then(res=> {
            this.setState({
...
getSeverityIndex(){
    axios
        .get('http://localhost:8085/defectservices/getseverityindex')
        .then(res=> {
            let color=""
            if(3>res.data){
               color='#12cc1f'
